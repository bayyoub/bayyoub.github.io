...
export default function Join() {
  return <main>
    ...
    <section className="section-shell join-content"><div className="join-main"><p className="section-label">Get in touch</p><h2>Send a brief introduction.</h2><p>Describe your research interests and background. Students can include a CV and relevant experience with programming, simulation, thermodynamics, or materials science. Prior experience with every method is not expected.</p><a className="button button-dark" href="mailto:bader.alayyoub@ku.edu.kw?subject=QSMD%20research%20inquiry">Email Dr. Alayyoub <span aria-hidden="true">↗</span></a><p className="email-address">bader.alayyoub@ku.edu.kw</p></div><aside className="join-aside"><span className="section-label">Research interests</span><ul><li>Density functional theory</li><li>Metal oxides and perovskites</li><li>Molecular dynamics and enhanced sampling</li><li>Interfacial processes and dissolution</li></ul></aside></section>
  </main>;
}
